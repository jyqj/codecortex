...
fn framework_for_router_object(obj: &str) -> &'static str {
...
fn classify_literal(value: &str) -> Option<&'static str> {
...
fn detect_nextjs_file_route(file_path: &str, symbols: &[SymbolRecord]) -> Option<RouteEdgeRecord> {
...
impl JsTsParser {
    ...
    fn try_extract_nestjs_decorator_route(
        &self,
...
fn is_event_registration(method: &str) -> bool {
    matches!(
        method,
...
fn is_event_dispatch(method: &str) -> bool {
    matches!(
        method,
...
fn extract_handler_expr(call_node: &tree_sitter::Node, source: &[u8]) -> Option<String> {
